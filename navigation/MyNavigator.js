    ...
    >
      <Drawer.Screen
        ...
        options={({ route, navigation }) => ({
          ...
          drawerIcon: ({ color }) => {
            return <AntDesign name="home" size={40} color="black" />;
          },
        })}
      />
      ...
      <Drawer.Screen
        ...
        options={({ route, navigation }) => ({
          ...
          drawerIcon: ({ color }) => {
            return <FontAwesome5 name="user-edit" size={35} color="black" />;
          },
        })}
      />
      ...
      <Drawer.Screen
        ...
        options={({ route, navigation }) => ({
          ...
          drawerIcon: ({ color }) => {
            return <Ionicons name="md-key-outline" size={40} color="black" />;
          },
        })}
      />
      ...
      <Drawer.Screen
        ...
        options={{
          ...
          headerShown: false,
          drawerIcon: ({ color }) => {
            return <MaterialIcons name="logout" size={40} color="black" />;
          },
        }}
      />
    </Drawer.Navigator>
...
export default function MyNavigator() {
  return <NavigationContainer>{Login()}</NavigationContainer>;
}
